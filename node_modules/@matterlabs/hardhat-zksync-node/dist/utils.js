...
exports.startServer = exports.configureNetwork = exports.getNetworkConfig = exports.adjustTaskArgsForPort = exports.getAvailablePort = exports.waitForNodeToBeReady = exports.isPortAvailable = exports.download = exports.getNodeUrl = exports.getLatestRelease = exports.getRPCServerBinariesDir = exports.getPlatform = exports.constructCommandArgs = void 0;
...
async function getNodeUrl(repo, release) {
    ...
    return semver_1.default.gte(release, '0.1.0')
...
const startServer = async (tag, force = false) => {
    const platform = getPlatform();
    if (platform === 'windows' || platform === '') {
        throw new errors_1.ZkSyncNodePluginError(`Unsupported platform: ${platform}`);
    }
